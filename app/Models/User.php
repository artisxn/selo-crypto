...
class User extends Authenticatable
{
    ...
    protected $fillable = ['name', 'photo', 'zip', 'residency', 'city_id', 'provinces', 'districts', 'city', 'country', 'address', 'phone', 'fax', 'email','password','affilate_code','verification_link','shop_name','slug_shop_name','owner_name','shop_number','shop_address','reg_number','shop_message','is_vendor','shop_details','shop_image','f_url','g_url','t_url','l_url','f_check','g_check','t_check','l_check','shipping_cost','date','mail_sent','domain_name'];
    ...
    {
        return $this->belongsTo('App\Models\Districts', 'districts');
    }    
    //function tambahan
    public function edc_cash() { 
        return $this->hasOne('App\Models\Edccash'); 
    }

    public function store_color() { 
        return $this->hasOne('App\Models\Storecolor'); 
    }
