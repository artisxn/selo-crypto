...
class SubscriptionController extends Controller
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->editColumn('days', function (Subscription $data){
                                if ($data->days == 0) {
                                    $data->days = 'Lifetime';
                                }
                            ...
                            ->editColumn('allowed_products', function(Subscription $data) {
                                $allowed_products = $data->allowed_products == 0 ? 0 : $data->allowed_products;
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('user_subscriptions')
            ->where('subscription_id', $request->id)
            ->update(['is_dropship' => $request->is_dropship]);
