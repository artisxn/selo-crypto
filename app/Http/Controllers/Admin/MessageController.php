...
class MessageController extends Controller
{
    ...
    public function message($id)
    {
        ...
        return view('admin.message.create',compact('conv', 'order', 'cart'));                 
    }   
        ...
        if ($request->conversation_id <> '') {
            ...
            if ($conv->type === 'Dispute') {
                try {
                    ...
                    $notifVendor->user_id = $conv->vendor_id;
                    $notifVendor->conversation_id = $conv->id;
                    $notifVendor->is_read = '0';
    ...
    public function status($id)
    {
        ...
        return redirect()->route('admin-message-dispute');
    }
}