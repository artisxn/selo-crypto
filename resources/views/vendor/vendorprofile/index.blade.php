          ...
          @endif
            ...
            <div class="row">
              ...
              <div class="row">
								<div class="col-lg-4">
                <div class="left-area">
										<h4 class="heading">Nama Bank</h4>
									</div>
								</div>
								<div class="col-lg-7">
									<input type="text" class="input-field" 
										name="bank" required="" value="{{$data->bank}}">
								</div>
							</div>
              ...
              <div class="row">
								<div class="col-lg-4">
                <div class="left-area">
										<h4 class="heading">Cabang</h4>
									</div>
								</div>
								<div class="col-lg-7">
									<input type="text" class="input-field" 
										name="cabang" required="" value="{{$data->cabang}}">
								</div>
							</div>							
              ...
              <div class="row">
                ...
                <div class="left-area">
										...
										<p class="sub-heading">Untuk ganti domain, <br> silahkan  hubungi admin.</p>
									</div>
								</div>
								<div class="col-lg-7">
									<input type="text" class="input-field" 
										name="domain_name" required="" value="{{$data->domain_name}}" disabled> 
								</div>
							</div>							
							@endif
