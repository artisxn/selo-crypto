...
@section('content')  
					...
					<div class="content-area">
						...
						@include('includes.vendor.form-success') 
										{{-- <div class="alert alert-{{ $highlight->sisa_highlight_product > 5 ? "success" : "danger"}} alert-dismissible">
											<button type="button" class="close" data-dismiss="alert">&times;</button>
											{{ _("Sisa Highlight Product Diizinkan : ").$highlight->sisa_highlight_product }}
										</div>  --}}
