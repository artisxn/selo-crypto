					...
					<div class="body-area">
						...
						<form id="geniusform" action="{{route('vendor-prod-update',$data->id)}}" method="POST"
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<select id="subcat" name="subcategory_id">
										...
										<option data-href="{{ route('vendor-childcat-load',$sub->id) }}" value="{{$sub->id}}">{{$sub->name}}
										</option>
										@endforeach
										@else
										@foreach($data->category->subs as $sub)
										<option data-href="{{ route('vendor-childcat-load',$sub->id) }}" value="{{$sub->id}}"
											{{$sub->id == $data->subcategory_id ? "selected":""}}>{{$sub->name}}</option>
										@endforeach
										@endif
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<input name="price" step="0.1" type="number" class="input-field" placeholder="{{ $langg->lang666 }}"
										value="{{round($data->publish_price <> '' ? $data->publish_price : $data->price * $sign->value , 2)}}" required="" min="0">
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<input name="previous_price" step="0.1" type="number" class="input-field"
										placeholder="{{ $langg->lang666 }}" value="{{round($data->publish_previous_price <> '' ? $data->publish_previous_price : $data->previous_price * $sign->value , 2)}}"
										min="0">
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="featured-keyword-area">
												...
												<div class="row">
													...
													<div class="col-lg-6">
														<div class="input-group colorpicker-component cp">
															<input type="text" name="colors[]" value="{{ $data->colors[$key] }}"
										...
										<a href="javascript:;" id="feature-btn" class="add-fild-btn"><i class="icofont-plus"></i>
											{{ $langg->lang688 }}</a>
									</div>
								</div>
							</div>
