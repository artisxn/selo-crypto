                      ...
                      <li>
                        ...
                        @include('includes.vendor.form-both')
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ $langg->lang632 }}" name="name" required="" value="{{ $data->name }}" disabled>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
															<select id="cat" name="category_id" required="" disabled>
                                              ...
                                              @endforeach
												...
												<div class="row">
													...
													<div class="col-lg-7">
															<select id="childcat" name="childcategory_id" {{$data->subcategory_id == null ? "disabled":""}} disabled>
									...
									<div class="col-lg-7">
										<label class="switch">
											<input type="checkbox" name="is_highlight" value="1" {{ $data->is_highlight == '1' ? 'checked' : null }}>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
															...
															<p class="sub-heading">
																({{ __('Harga ini sudah termasuk fee company') }} {{ $gs->rate_company }}%)
															</p>															
														</div>
													</div>
													<div class="col-lg-7">
														<input name="price" step="0.1" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" value="{{round($data->publish_price <> '' ? $data->publish_price : $data->price * $sign->value , 2)}}" required="" min="0">
													</div>
												</div>
													...
													<div class="col-lg-4">
														...
														<div class="col-lg-7">
															<input name="previous_price" step="0.1" type="number" class="input-field"
																placeholder="{{ $langg->lang666 }}" min="0" value="{{ round($data->publish_previous_price, 2) }}">
														</div>																											
												</div> -->
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="text-editor">
										<input type="number" name="weight" class="input-field" value="{{ $data->weight }}">
									</div>
								</div>
							</div>											
												...
												<input type="hidden" name="features[]" class="input-field" placeholder="{{ $langg->lang687 }}" value="">
