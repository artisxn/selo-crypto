							...
							<div class="row">
								...
								<div class="col-lg-7">
									<input name="previous_price" step="0.1" type="number" class="input-field"
										placeholder="{{ $langg->lang666 }}"
										value="{{round($data->publish_previous_price <> '' ? $data->publish_previous_price : $data->previous_price * $sign->value , 2)}}" min="0">
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-4">
									<div class="left-area">
										...
										<p class="sub-heading">{{ $langg->lang668 }}<</p> </div> </div> <div
												class="col-lg-7">
												<input type="text" class="input-field"
													placeholder="{{ $langg->lang701 }}" name="platform"
													value="{{ $data->platform }}">
									</div>
								</div>
									...
									<div class="col-lg-4">
										<div class="left-area">
											...
											<p class="sub-heading">{{ $langg->lang668 }}<</p> </div> </div> <div
													class="col-lg-7">
													<input type="text" class="input-field"
														placeholder="{{ $langg->lang702 }}" name="region"
														value="{{ $data->region }}">
										</div>
									</div>
										...
										<div class="col-lg-4">
											<div class="left-area">
												...
												<p class="sub-heading">{{ $langg->lang668 }}<</p> </div> </div> <div
														class="col-lg-7">
														<input type="text" class="input-field"
															placeholder="{{ $langg->lang703 }}e" name="licence_type"
