				...
				<div class="product-description">
					<div class="body-area">
						...
						<form id="geniusform" action="{{route('vendor-prod-store')}}" method="POST"
							enctype="multipart/form-data" data-redirect="{{ route('vendor-prod-index') }}">
							{{csrf_field()}}
							...
							{{-- <div class="row"> --}}
								...
								{{-- <div class="col-lg-7">
									<input type="hidden" class="input-field" placeholder="{{ $langg->lang794 }}"
										name="sku" required=""
										value="{{ str_random(3).substr(time(), 6,8).str_random(3) }}">

									<div class="checkbox-wrapper">
										<input type="hidden" name="product_condition_check" class="checkclick"
							...
							{{-- <div class="row social-links-area">
									<div class="col-lg-4">
										<div class="left-area">
											<h4 class="heading">{{ _("Highlight Product") }}*</h4>
										</div>
									</div>
									<div class="col-lg-7">
										<label class="switch">
							...
							<div class="row">
								<div class="col-lg-4">
									<div class="left-area">
										...
										<p class="sub-heading">
											( <b style="color: red;"> {{ __('Harga ini sudah termasuk fee company') }} {{ $gs->rate_company }}% </b> )
										</p>
									</div>
								</div>
								<div class="col-lg-7">
							...
							<input type="hidden" name="features[]" class="input-field"
							...
							<div class="row">
								...
								<div class="col-lg-7 text-center">
									<button class="addProductSubmit-btn" type="button" data-toggle="modal" data-target="#confirm-product">{{ $langg->lang690 }}</button>
								</div>
							</div>
						</form>
					</div>
...
<div class="modal fade" id="confirm-product" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header d-block text-center">
					<h4 class="modal-title d-inline-block">{{ _("Konfirmasi Barang") }}</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				...
				<div class="modal-body">
					<p class="text-center">{{ __('Apakah anda sudah memasukkan harga yang sudah termasuk fee company') }} {{ $gs->rate_company }}% ?</p>
				</div>
	
				<div class="modal-footer justify-content-center">
					<button type="button" class="btn btn-danger"
						data-dismiss="modal">{{ __('Tidak') }}</button>

					<button type="button" class="btn btn-success upload-product"
						data-dismiss="modal">{{ __('Ya') }}</button>						
				</div>		
			</div>
		</div>
	</div>
...
$(document).on('click', '.upload-product', function () {
                ...
                for (var i = 0; i < elementArray.length; ++i) {
                  nicEditors.findEditor(elementArray[i]).saveContent();
                }
	$('#geniusform').submit();
});
