...
<section class="user-dashbord">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="user-profile-details" style="border:none!important;">
                    <div class="order-details" style="border:none!important;">
                        ...
                        @php
                            ...
                            $pajaknya += ($harga_asli / 100) * $order->tax;
                        @endphp
                        @endforeach
                        <div class="view-order-page" style="margin-top:100px;">
                            <h3 class="order-code">{{ $langg->lang285 }} {{$order->order_number}} <span style="float:right;color:#EF4623;">{{$order->status}}</span>
                            </h3>
                            <h5>Nomor Resi: {!! $order->no_resi ? '<a href="javascript:void(0);" style="color: #EF4623;" data-kurir="'.$order->kurir.'" data-resi="'.$order->no_resi.'" class="btn-track">'.$order->no_resi.'</a>' : 'Belum tersedia' !!}</h5>
                            <div class="print-order text-right">
                                <a href="{{route('user-order-print',$order->id)}}" target="_blank"
                                    class="btn btn-outline-danger btn-sm" style="background-color:#fff!important;color:#EF4623;">
                                    <i class="fa fa-print"></i> {{ ucwords($langg->lang286) }}
                                </a>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p>{{ $langg->lang293 }}
                                            ...
                                            {{$order->currency_sign}} @rp( round($order->pay_amount * $order->currency_value , 2) )
                                        </p>
                            ...
                            <div class="shipping-add-area">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        @elseif($order->shipping == "another" || $order->shipping <> '') 
                                        <h5>{{ $langg->lang302 }}</h5>
                                        <address>
                                            {{ $langg->lang288 }}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p>Paket Pengiriman: {{$order->paket_kurir}}</p>
                                        <!-- @if($order->shipping == "shipto")
                                        <p>{{ $langg->lang306 }}</p>
                                        @else
                                        <p>{{ $langg->lang307 }}</p>
                            ...
                            <div class="billing-add-area">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p>{{ $langg->lang798 }}
                                             {!! $order->payment_status == 'Pending' ? "<span class='badge badge-danger' style='background-color:#fff!important;color:#EF4623!important;font-size:14px!important;'>". $langg->lang799 ."</span>":"<span class='badge badge-success'>". $langg->lang800 ."</span>" !!}
                                        </p>
                                        <!-- Hari ini  -->
                                        <p>{{ $langg->lang293 }}
                                            {{$order->currency_sign}} @rp( round($order->pay_amount  * $order->currency_value , 2) )
                                        ...
                                        <p>{{ $langg->lang294 }} {{$order->method}}</p>
                                            ...
                                            {{-- <p>Tax:  {{$order->currency_sign}} @rp( round($order->pay_amount * $order->currency_value / $gs->tax , 2) ) </p> --}}
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered veiw-details-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            {{$order->currency_sign}} @rp( round(($product["price"] / $product['qty']) * $order->currency_value,2) ) 
                                            </td>
                                            <td> 
                                                {{-- {{$order->currency_sign}}{{ round($order->pay_amount * $order->currency_value + $order->pay_amount * $order->currency_value / $gs->tax, 2) }}  --}}
                                                {{$order->currency_sign}} @rp( round($product['price'] * $order->currency_value, 2) ) 


                                            {{-- $order->currency_sign}}{{round($product['price'] * $order->currency_value,2) --}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            {{$order->currency_sign}} @rp( round($order['shipping_cost']* $order->currency_value, 2) ) 
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="edit-account-info-div">
                                    <div class="form-group">
                                        <a class="btn btn-orange" href="{{ route('user-orders') }}" style="float:right;">{{ $langg->lang318 }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
