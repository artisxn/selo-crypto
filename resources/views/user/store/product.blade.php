...
<tbody>
<tr>
<td><span style="color: #A5A5A5;font-size: 12px;"> {{ $kota->name }} 
       </span></td>
<td><div class="stars">
                              <div class="ratings">
                                <div class="empty-stars"></div>
    ...
    <li>
     ...
     <li>
      <a  class="view-stor" href="javascript;">
        ...
        <p style="margin-top:15px;">Store {{ $langg->lang225 }}</p>
        <!-- <img src="{{ asset('assets/images/icons/All Asset-18.png') }}" alt="" style="display:inline!important;width:30px;height:30px; margin-top: 15px;"> -->
    ...
    @endif
     ...
     <a href="javascript:;" data-toggle="modal" data-target="{{ Auth::guard('web')->check() ? '#vendorform1' : '#comment-log-reg' }}"><li><img src="{{ asset('assets/images/icons/All Asset-20.png') }}" alt="" style="display:inline!important;width:30px;height:30px; margin-top: 15px;">
  ...
  <li>&nbsp;</li>
    <li>&nbsp;</li>
              ...
              <li>  <a href="{{ route('product.cart.quickadd',$productt->id) }}" class="myButton91">{{ $langg->lang251 }}</a></li> -->
      <!-- awal penambahan stok kosong -->
              <li>Total Harga<br><span style="color:#EF4623;font: SemiBold 22px/25px Kanit;">{{ $productt->showPrice() }}</span></li>
                ...
                @else 
                  <li>  
                    ...
                    <a id="qaddcrt" href="{{ route('product.cart.quickadd',$productt->id) }}" class="myButton91">{{ $langg->lang251 }}</a>
                  </li>

                  <li>  <a href="javascript:;" data-href="{{ route('product.cart.add',$productt->id) }}"  class="myButton91 add-to-cart">Ke Keranjang</a></li> 
                             
                @endif 
              
 </ul>

 <!-- akhir penambahan stok kosong -->              
