                    ...
                    <div class="account-info">
                        ...
                        <div class="pack-details">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <h5 class="title">
                                        {{ _("Highlight ").$langg->lang414 }}
                                    </h5>
                                </div>
                                <div class="col-lg-8">
                                    <p class="value">
                                        {{ $subs->allowed_products == 0 ? 0:  $subs->allowed_products}}
                                    </p>
                                </div>
                            </div>
                            ...
                            <form id="subscribe-form" class="pay-form" action="{{route('user-vendor-request-submit')}}"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <h5 class="title pt-1">
                                            {{ __('Nomor Telepon Toko') }} *
                                        </h5>
                                    </div>
                                    <div class="col-lg-8">
                                        <input type="text" class="option" name="shop_number"
                                            placeholder="{{ __('Nomor Telepon Toko') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" class="option" name="rekening_no"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="option" name="rekening_name"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="option" name="bank_name"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="option" name="cabang_name"
                                            placeholder="Cabang" required>
                                    </div>
                                </div>    
                                <br>                            
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="option" name="domain_name"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <select name="method" id="option" onchange="meThods(this)" class="option"
                                            ...
                                            @endif
                                            @if($gs->is_gv == 1)
                                            <option value="GudangVoucher">{{ _("Gudang Voucher") }}</option>
                                            @endif                                            
                                        </select>
...
<script type="text/javascript">
    function meThods(val) {
            ...
            var action8 = "{{route('user.gv.submit')}}";
            ...
            else if (val.value == "GudangVoucher") {
               $('.pay-form').attr('id','subscribe-form');
