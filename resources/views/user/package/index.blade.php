                            ...
                            <div class="elegant-pricing-tables style-2 text-center">
                                <div class="pricing-head">
                                    ...
                                    <span class="price">
                                        ...
                                        <span class="price-digit">@rp($sub->price)</span><br>
                                        <!-- {{ _("Highlight ").$langg->lang414 }} {{ $sub->allowed_products }} -->
                                ...
                                <br>
                                    @if($package->days !== 0)
                                        ...
                                        <small class="hover-white">{{ $langg->lang405 }}
                                            {{ date('d/m/Y',strtotime($user->date)) }}</small>
                                        @else
                                        <small class="hover-white">{{ $langg->lang406 }}
                                            {{ date('d/m/Y',strtotime($user->date)) }}</small>
                                        @endif
                                        <a href="{{route('user-vendor-request',$sub->id)}}"
                                        class="hover-white"><u>{{ $langg->lang407 }}</u></a>                                    
                                    @endif
                                @else
                                <a href="{{route('user-vendor-request',$sub->id)}}"
