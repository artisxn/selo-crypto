  ...
  @endif
    ...
    <div class="row row-cards-one">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg2">
                <div class="left">
                    <h5 class="title">{{ __('Paid Orders!') }}</h5>
                    <span class="number">{{count($paid)}}</span>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg1">
                <div class="left">
                    <h5 class="title">{{ __('Waiting Vendor Payment!') }}</h5>
                    <span class="number">{{count($vendorPayment)}}</span>
                    <a href="{{ route('admin-order-vendor-payment') }}" class="link">{{ __('View All') }}</a>
                </div>
                <div class="right d-flex align-self-center">
                    <div class="icon">
                        <i class="icofont-check-circled"></i>
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="mycard bg3">
                    <div class="left">
                        <h5 class="title">{{ __('Waiting Dropshipper Payment!') }}</h5>
                        <span class="number">{{count($dropshipPayment)}}</span>
                        <a href="{{ route('admin-order-dropshipper-payment') }}" class="link">{{ __('View All') }}</a>
                    </div>
                    <div class="right d-flex align-self-center">
                        <div class="icon">
                            <i class="icofont-check-circled"></i>
