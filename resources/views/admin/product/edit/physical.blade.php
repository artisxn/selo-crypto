				...
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
											...
											<div class="row">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="previous_price" step="0.1" type="number" class="input-field" placeholder="{{ $langg->lang666 }}" value="{{round($data->publish_previous_price <> '' ? $data->publish_previous_price : $data->publish_previous_price * $sign->value , 2)}}" min="0">
													</div>
												</div>
