                        ...
                        <table id="geniustable" style="font-size: 13px;" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('Vendor Payment Date') }}</th>
                                    <th>{{ __('Dropshipper Payment Date') }}</th>
                                    <th>{{ __('Options') }}</th>
                                </tr>
                            </thead>
                        </table>
...
<script type="text/javascript">
    var table = $('#geniustable').DataTable({
               ...
               columns: [
                        ...
                        { data: 'payment_vendor_date', name: 'payment_vendor_date'},
                        { data: 'payment_dropshipper_date', name: 'payment_dropshipper_date'},                        
