            ...
            <div class="row invoice__metaInfo mb-4">
                <div class="col-lg-6">
                    <div class="invoice__orderDetails">
                        ...
                        <span><strong>{{ __('Invoice Number') }} :</strong> {{ sprintf("%'.08d", $order->invoice->invoice_number) }}</span><br>
                                ...
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               @if($product['color'])
                                                ...
                                                @endif
                                                <p>
                                                        <strong>{{ __('Price') }} :</strong> {{$order->currency_sign}} @rp(round( $product['item']['publish_price']  * $order->currency_value , 2))
                                                </p>
                                               <p>
                                            ...
                                            <td>
                                                {{-- {{$order->currency_sign}} @rp(round(($order->method === 'EDCCASH' ? $product['price_edc'] : $product['price']) * $order->currency_value , 2)) --}}
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>{{$order->currency_sign}} @rp(round($subtotal, 2))</td>
                                        </tr>
                                        @if($order->shipping_cost != 0)
                                        <tr>
                                            <td colspan="2">{{ __('Shipping Cost') }}({{$order->currency_sign}})</td>
                                            <td>@rp(round($order->shipping_cost , 2))</td>
                                        </tr>
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            <td>@rp(round($order->packing_cost , 2))</td>
                                        </tr>
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            @endphp
                                            <td>@rp(round($tax, 2))</td>
                                        </tr>
                                        @endif
                                        @if($order->coupon_discount != null)
                                        <tr>
                                            <td colspan="2">{{ __('Coupon Discount') }}({{$order->currency_sign}})</td>
                                            <td>@rp(round($order->coupon_discount, 2))</td>
                                        </tr>
                                        @endif
                                        <tr>
                                            <td colspan="1"></td>
                                            <td>{{ __('Total') }}</td>
                                            <td>{{$order->currency_sign}} @rp(round($order->pay_amount * $order->currency_value  , 2))
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
