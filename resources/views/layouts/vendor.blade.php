	...
	<body>
						...
						<div class="d-flex justify-content-between">
							...
							<div class="right-eliment">
								<ul class="list">
									...
									<li class="bell-area" data-toggle="tooltip" data-placement="top" title="Komplain" data-original-title="Komplain">
										<a id="notf_conv" class="dropdown-toggle-1" href="javascript:;">
											<i class="far fa-envelope"></i>
											<span data-href="{{ route('vendor-conv-notf-count') }}" id="conv-notf-count">{{ App\Models\Notification::countVendorConversation(Auth::user()->id) }}</span>
										</a>
										<div class="dropdown-menu">
											<div class="dropdownmenu-wrapper" data-href="{{ route('vendor-conv-notf-show') }}" id="conv-notf-show">
										</div>
										</div>
									</li>

									<li class="bell-area" data-toggle="tooltip" data-placement="top" title="Pemesanan" data-original-title="Pemesanan">
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							@if ( (Auth::user()->subscribes <> '' ? Auth::user()->subscribes->is_dropship === '1' : false) )
								<li>
									<a href="{{ route('vendor-store-edit') }}" class="wave-effect active"><i class="fa fa-edit mr-2"></i>Edit Tampilan Toko</a>
								</li>									
							@endif
							<li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
									...
									<li>
										<a href="{{ route('vendor-prod-pending') }}"><span>{{ $langg->lang805 }}</span></a>
									</li>									
									{{-- <li>
							...
							@if ( (Auth::user()->subscribes <> '' ? Auth::user()->subscribes->is_dropship === '1' : false) )
							<li>
								<a href="#dropship" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
									<i class="icofont-cart"></i>Dropship 
								</a>
								<ul class="collapse list-unstyled" id="dropship" data-parent="#accordion">
									<li>
										<a href="{{route('vendor-dropship-index')}}"><span>Semua Produk Dropship</span></a>
									</li>
								</ul>
							</li>
							...
							<li>
								<a href="{{ route('vendor-payment-index') }}" class=" wave-effect"><i class="fas fa-list"></i>{{ __('Penerimaan Pembayaran') }}</a>
							</li>							

							<li>
								<a href="{{ route('vendor-dmessage-index') }}" class=" wave-effect"><i class="fas fa-list"></i>{{ __('Komplain Pesanan') }}</a>
							</li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="general" data-parent="#accordion">
									...
									<li>
										<a href="{{ route('vendor-profile-edit') }}"><span>Edit Vendor Profil</span></a>
									</li>
		...
		<script>
			$('.itemName').select2({
				...
				ajax: {
				url: '{{route('vendor-dropship-show-product')}}',
				dataType: 'json',
				delay: 250,
