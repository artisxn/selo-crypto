						...
						<div class="d-flex justify-content-between">
							...
							<div class="right-eliment">
								<ul class="list">
									...
									<li class="bell-area" data-toggle="tooltip" data-placement="top" title="Visit EDC Store" data-original-title="Visit EDC Store">
									...
									<li class="bell-area" data-toggle="tooltip" data-placement="top" title="Conversation" data-original-title="Conversation">
									...
									<li class="bell-area" data-toggle="tooltip" data-placement="top" title="New & Low Quantity Product" data-original-title="New & Low Quantity Product">
									...
									<li class="bell-area" data-toggle="tooltip" data-placement="top" title="New User Registered" data-original-title="New User Registered">
									...
									<li class="bell-area" data-toggle="tooltip" data-placement="top" title="New Order" data-original-title="New Order">
									...
									<li class="bell-area" data-toggle="tooltip" data-placement="top" title="Status Order" data-original-title="Status Order">
										<a id="notf_status_order" class="dropdown-toggle-1" href="javascript:;">
											<i class="far fa-list-alt"></i>
											<span data-href="{{ route('trans-order-notf-count') }}" id="trans-order-notf-count">{{ App\Models\Notification::countTransOrder() }}</span>
										</a>
										<div class="dropdown-menu">
											<div class="dropdownmenu-wrapper" data-href="{{ route('trans-order-notf-show') }}" id="trans-order-notf-show">
										</div>
										</div>
									</li>									
