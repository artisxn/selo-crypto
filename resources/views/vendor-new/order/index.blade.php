                            ...
                            <tbody style="font-size: 13px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{$order->order->currency_sign}} @rp( round($price * $order->order->currency_value, 2) )
                                        @else
                                            -
                                        @endif
                                    </td>
                                    <td>
                                        {{ $order->order->method === 'EDCCASH' ? round($price / $gs->edccash_currency, 3). ' EDC' : '-' }}
                                    </td>
                                        ...
                                        <div class="action-list">
                                            ...
                                            <select class="vendor-btn {{ $order->status }}">
                                                <option
                                                    ...
                                                    {{  $order->status == "pending" ? 'selected' : ''  }} {{ $order->status == "completed" ? 'disabled' : null }} data-status="pending">
                                                ...
                                                <option
                                                    ...
                                                    {{  $order->status == "processing" ? 'selected' : ''  }} {{ $order->status == "completed" ? 'disabled' : null }} data-status="processing">
                                                ...
                                                <option
                                                    ...
                                                    {{  $order->status == "declined" ? 'selected' : ''  }} {{ $order->status == "completed" ? 'disabled' : null }} data-status="declined">
                                                ...
                                                <option
                                                    ...
                                                    {{  $order->status == "completed" ? 'selected' : ''  }} {{ $order->status !== "completed" ? 'disabled' : null }} data-status="completed">
