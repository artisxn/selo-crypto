									@if(Session::has('cart'))
										<div class="dropdownmenu-wrapper" style="margin-top:-10px!important;">
															...
															<div class="product-details">
																<div class="content">
																	...
																	<span class="cart-product-info">
																		...
																		x <span id="prct{{$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])}}">{{ App\Models\Product::convertPrice($product['item']['publish_price']) }}</span>
																	</span>
																</div>
