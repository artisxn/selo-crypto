...
@if(Auth::guard('admin')->user()->sectionCheck('products'))
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-prod-pending') }}"><span>{{ __('Pending Products') }}</span></a>
            </li>            
            <li>
...
@if(Auth::guard('admin')->user()->sectionCheck('vendors'))
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="vendor" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-vendor-subs-verification') }}"><span>{{ __('Vendor Subscriptions Verification') }}</span></a>
            </li>
            {{-- <li>
...
@if (Auth::guard('admin')->user()->sectionCheck('payment'))
<li>
    <a href="#payment" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="icofont-list"></i>{{ __('Payment') }}
    </a>
    <ul class="collapse list-unstyled" id="payment" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-order-vendor-payment') }}"><span>{{ __('Vendor Payment') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-order-dropshipper-payment') }}"><span>{{ __('Dropshipper Payment') }}</span></a>
        </li>
        {{-- <li>
            <a href="{{ route('admin-vendor-subs') }}"><span>{{ __('Vendor Subscriptions') }}</span></a>
        </li>
...
@if(Auth::guard('admin')->user()->sectionCheck('manage_staffs'))
    ...
    <li>
        <a href="{{ route('admin-staff-index') }}" class=" wave-effect"><i class="fas fa-user-secret"></i>{{ __('Manage User') }}</a>
    </li>
...
@if (Auth::guard('admin')->user()->sectionCheck('report'))
        <li>
            <a href="#report" class=" wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-receipt"></i>{{ __('Report') }}</a>
            <ul class="collapse list-unstyled" id="report" data-parent="#accordion">
                <li><a href="{{ route('admin-report-order') }}"> {{ __('Order') }}</a></li>
                <li><a href="{{ route('admin-report-payment') }}"> {{ __('Payment') }}</a></li>
            </ul>
        </li>
@endif
