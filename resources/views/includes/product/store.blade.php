<div class="col-lg-3 col-md-4 col-6 padding-8">
        ...
        <a href="{{ route('front.product', $prod->slug) }}" class="item">
            ...
            <div class="item-cart-area" style="height: 62%; width: 95%;">
                ...
                @else
                    ...
                    {{-- <span  data-href="{{ route('product.cart.add',$prod->id) }}"> --}}
                            <img class="add-to-cart" data-href="{{ route('product.cart.add', [$prod->id, $prod->slug_shop_name] ) }}" src="{{ asset('assets/images/icons/cart.png') }}" style="width: 28%; padding: 10px; margin-left: 110px; margin-top: 15px;" alt="" srcset="">
                            <br>
